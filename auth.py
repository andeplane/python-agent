...
def create_client():
    CLUSTER_NAME="bluefield"
    COGNITE_PROJECT="ai-bluefield"
    COGNITE_BASE_URL=f"https://{CLUSTER_NAME}.cognitedata.com"
    COGNITE_TENANT_ID=f"f2e218c3-d9eb-4fff-aa6a-cf8d0fd2d323"
    COGNITE_TOKEN_URL=f"https://login.microsoftonline.com/{COGNITE_TENANT_ID}/oauth2/v2.0/token"
    COGNITE_TOKEN_SCOPES=f"https://{CLUSTER_NAME}.cognitedata.com/.default"
    COGNITE_CLIENT_ID=os.getenv("COGAI_CLIENTID")
    COGNITE_CLIENT_SECRET=os.getenv("COGAI_CLIENTSECRET")
...
#         token = ""
#         return token
#     cnf = ClientConfig(client_name="DSHub", base_url="https://api.cognitedata.com", project="lervik-industries", credentials=Token(token_provider))
